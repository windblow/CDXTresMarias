...
public:
	...
	CDXBOOL Create(CDXScreen *pScreen, const TCHAR * szFilename, int w, int h, int num, BYTE memoryType = CDXMEM_VIDTHENSYS);
	...
	CDXBOOL CreateFromTLE(CDXScreen *pScreen, const TCHAR * szFilename , BYTE memoryType = CDXMEM_VIDTHENSYS );
