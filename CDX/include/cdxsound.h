...
public:
	...
	HRESULT Load( CDXSound* pDS, const TCHAR* Filename, int Num = 1 );
	...
	HRESULT LoadFromRes( CDXSound* pDS, const TCHAR* Filename, int Num = 1 );
...
private:
	...
	const TCHAR* m_Filename;		// The name of the WAVE file
