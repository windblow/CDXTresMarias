...
// Create a DirectDrawSurface from a bitmap resource.
////////////////////////////////////////////////////////////////////////
extern "C" CDX_LPDIRECTDRAWSURFACE DDLoadBitmap(CDX_LPDIRECTDRAW pdd, LPCTSTR szBitmap, int dx, int dy, BOOL memoryType)
{
    HBITMAP                 hbm;
    BITMAP                  bm;
...
////////////////////////////////////////////////////////////////////////
CDX_LPDIRECTDRAWSURFACE DDLoadSizeBitmap(CDX_LPDIRECTDRAW pdd, LPCTSTR szBitmap, int *dx, int *dy, BOOL memoryType)
{
	HBITMAP                 hbm;
	BITMAP                  bm;
	CDX_DDSURFACEDESC       ddsd;
...
////////////////////////////////////////////////////////////////////////
HRESULT DDReLoadBitmap(CDX_LPDIRECTDRAWSURFACE pdds, LPCTSTR szBitmap)
{
    HBITMAP             hbm;
    HRESULT             hr;
    ...
    if (hbm == NULL)
    {
        OutputDebugString((LPCTSTR)L"handle is null\n");
        return E_FAIL;
    }
    ...
    if (hr != DD_OK)
    {
        OutputDebugString((LPCTSTR)L"ddcopybitmap failed\n");
    }
...
extern "C" HRESULT DDCopyBitmap(CDX_LPDIRECTDRAWSURFACE pdds, HBITMAP hbm, int x, int y, int dx, int dy)
{
    ...
    if (!hdcImage)
        OutputDebugString((LPCTSTR)L"createcompatible dc failed\n");
