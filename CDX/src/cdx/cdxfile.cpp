...
/////////////////////////////////////////////////////////////////////
int CDXFile::OpenCommon(LPCTSTR FileName, DWORD Access, DWORD Sharing, DWORD CreateDisposition)
{
	Close();
...
// Returns 0 if file opened ok, <0 otherwise
/////////////////////////////////////////////////////////////////////
int CDXFile::Open(const TCHAR *FileName)
{
...
// Returns 0 if file opened ok, <0 otherwise
/////////////////////////////////////////////////////////////////////
int CDXFile::OpenRead(const TCHAR *FileName)
{
...
// Returns 0 if file opened ok, <0 otherwise
/////////////////////////////////////////////////////////////////////
int CDXFile::OpenWrite(const TCHAR *FileName)
{
