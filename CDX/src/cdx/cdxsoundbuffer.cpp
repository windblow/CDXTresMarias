...
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSoundBuffer::Load(CDXSound* pDS, const TCHAR *Filename, int Num)
{
...
// if necessary so try to keep this number small.
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSoundBuffer::LoadFromRes( CDXSound* pDS, const TCHAR *Filename, int Num )
{
	if( Filename == NULL ) return DSERR_INVALIDPARAM;
	...
	if((( hResInfo = FindResource(NULL, Filename, _T("WAV"))) == NULL ) ) return DSERR_GENERIC;
...
HRESULT CDXSoundBuffer::UpdateStream( BOOL FillAll )
{
	...
	do
	{
		if(pos!=m_sCurrent)
		{
			...
			TCHAR str[255];
			_stprintf( str, _T("PlayPos:%i\tFillPos:%i\tEndPos:%i\n"), pos, m_sCurrent, m_sDone );
			ODS( str );
