...
//////////////////////////////////////////////////////////////////////////////////
#ifdef SAVE_RCSID
static TCHAR rcsid[] = "@(#) $Id: cdxtile.cpp,v 1.9 2000/09/09 08:39:09 istan Exp $";
#endif
...
// in the bitmap.
//////////////////////////////////////////////////////////////////////////////////
CDXBOOL CDXTile::Create(CDXScreen *pScreen, const TCHAR *szFilename, int w, int h, int num, BYTE memoryType)
{
	int i;
	DWORD x, y;
...
//////////////////////////////////////////////////////////////////////////////////
#if 0
CDXBOOL CDXTile::CreateFromTLE(CDXScreen *pScreen, const TCHAR * szFilename , BYTE memoryType )
{
	if(szFilename == NULL) 
		return FALSE;
