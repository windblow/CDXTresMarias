...
CDXSurface::CDXSurface(CDXSurface& aSurface)					
{
    ...
    wcscpy(m_FileName, aSurface.m_FileName);
...
//
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSurface::Create(CDXScreen* pScreen,	const TCHAR *szFilename, BYTE memoryType)
{
    CDXImage* image;
    HRSRC hResInfo;
	HGLOBAL hResData;
...
//
//////////////////////////////////////////////////////////////////////////////////
wchar_t* CDXSurface::GetFileName(wchar_t* name)
{ 
	if(wcslen(m_FileName) != 0)
		wcscpy(name, m_FileName);
	else
		name = (wchar_t*)L"";
...
//
//////////////////////////////////////////////////////////////////////////////////
wchar_t* CDXSurface::GetFontName(wchar_t* name)
{ 
	if(wcslen(m_FontName) != 0)
		wcscpy(name, m_FontName);
	else
		name = (wchar_t*)L"";
...
//
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSurface::ChangeFont(LPCWSTR FontName, int Width, int Height, int Attributes)
{
    HRESULT rval;
...
HRESULT CDXSurface::TextXY(int x, int y, COLORREF col, LPCTSTR pString)
{
    ...
    if(dc != NULL)
    {
	    ...
	    SetTextColor(dc, col);
	    rval = ::TextOut(dc, x, y, pString, _tcslen(pString));
...
// 
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSurface::DrawText(LPCTSTR pString, COLORREF col, LPRECT pRect)
{
    HRESULT rval;
    HDC dc;
    ...
    if(dc != NULL)
    {
	    SetBkMode(dc, TRANSPARENT);
	    SetTextColor(dc, col);
	    rval = ::DrawText(dc, pString, _tcslen(pString), pRect, DT_WORDBREAK);
...
// 
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSurface::ReLoadBitmap(TCHAR * fileName)
{
...
// 
//////////////////////////////////////////////////////////////////////////////////
HRESULT CDXSurface::SaveAsBMP(LPCTSTR szFilename)
{
	HANDLE file_out;
    HRESULT rval;
    DWORD numwrite;
